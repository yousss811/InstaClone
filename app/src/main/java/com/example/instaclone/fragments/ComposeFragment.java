...
*/
    ...
    private Button butCaptureImage;
...
*/
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        butCaptureImage = view.findViewById(R.id.butCaptureImage);
        ivPostImage = view.findViewById(R.id.ivPostImage);
        butSubmit = view.findViewById(R.id.butSubmit);

        butCaptureImage.setOnClickListener(new View.OnClickListener() {
            @Override
